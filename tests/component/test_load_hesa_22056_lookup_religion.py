...
def run_etl_script():
    ...
    etl_script_name = "load_hesa_22056_lookup_religion.py"
...
#    run_etl_script()
    ...
    source_file = "hesa_22056_20240331_lookup_RELIGION.csv"
    source_path = os.path.join(config['deliveries_dir'], "22056_20240331", source_file)
    target_table = "load_hesa_22056_20240331_lookup_religion"
    column_mappings = {
        "Code": "code",
        "Label": "label"
        }
