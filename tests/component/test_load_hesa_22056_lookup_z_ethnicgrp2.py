...
def run_etl_script():
    ...
    etl_script_name = "load_hesa_22056_lookup_z_ethnicgrp2.py"
...
#    run_etl_script()
    ...
    source_file = "hesa_22056_20240331_lookup_Z_ETHNICGRP2.csv"
    source_path = os.path.join(config['deliveries_dir'], "22056_20240331", source_file)
    target_table = "load_hesa_22056_20240331_lookup_z_ethnicgrp2"
    column_mappings = {
        "Code": "code",
        "Label": "label"
        }
