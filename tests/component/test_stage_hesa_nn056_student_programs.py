...
def run_etl_script(etl_script_name):
    """Runs ETL script whose output is to be tested."""
...
def main():
    ...
    source_csv = "expected_stage_hesa_nn056_student_programs.csv"
...
if __name__ == "__main__":
    run_etl_script("stage_hesa_nn056_student_programs.py")
    main()
