...
def init():
    ...
    config['output_table'] = 'stage_hesa_nn056_student_programs'
    config['output_cols'] = ['student_guid', 'program_guid', 'enrol_date', 'fees_paid', 'source_file', 'hesa_delivery']

    config['source_query'] = {'sql': """SELECT t1.student_guid, t1.program_guid, t1.enrol_date,
                                        t1.fees_paid, t1.source_file, t1.hesa_delivery
                                        FROM load_hesa_22056_student_programs t1""",
                             'cols': ['student_guid', 'program_guid', 'enrol_date',
                                      'fees_paid', 'source_file', 'hesa_delivery']}
